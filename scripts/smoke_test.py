...
# and only fail when actually called. tunnels() lists active tunnels -- with
# none open it returns zero rows, which is a successful call.
SMOKE_QUERY = "SELECT count(*) AS n FROM tunnels();"
# ─────────────────────────────────────────────────────────────────────────────
